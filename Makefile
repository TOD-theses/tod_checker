...
test: lint        ## Run tests and generate coverage report.
	$(ENV_PREFIX)pytest -v --cov-config .coveragerc --cov=tod_checker -l --tb=short --maxfail=1 tests/
...
release:          ## Create a new tag for release.
	...
	@echo "$${TAG}" > tod_checker/VERSION
	@$(ENV_PREFIX)gitchangelog > HISTORY.md
	@git add tod_checker/VERSION HISTORY.md
